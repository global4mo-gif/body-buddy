      ...
      <div className="screen fade-in">
        ...
        <div className="card sand">
          ...
          <p style={{ fontSize: 13.5 }}>
            {{
              lose: 'Сбросить вес: держите дефицит калорий из плана, белок в каждом приёме пищи и воду по цели — она снижает ложный голод.',
              maintain: 'Поддерживать форму: стабильность важнее рывков — план калорий, регулярный стек и сон 7–8 часов.',
              gain: 'Набрать вес: профицит из плана, упор на белок и силовые тренировки; креатин — рабочий помощник.',
            }[state.profile.goal] || 'Держите курс — постоянство решает.'}
          </p>
          {state.profile.plan && (
            <p className="tiny" style={{ marginTop: 8 }}>
              🎯 Ваш план: {state.profile.plan.kcal.toLocaleString('ru-RU')} ккал ·
              Б {state.profile.plan.protein} г · У {state.profile.plan.carbs} г · Ж {state.profile.plan.fat} г
            </p>
          )}
        </div>
